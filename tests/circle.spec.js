...
describe('4 - Implemente os casos de teste para a função `circle`', () => {
  it('Verifica se ao receber um raio, a função `circle` retorna um objeto contendo os valores esperados', () => {
    ...
    expect(circle('1')).toEqual(undefined);
    // Teste se circle retorna um objeto.
    expect(typeof circle(1)).toEqual("object");
    // Teste se o objeto retornado possui 3 propriedades.
    expect(circle(3).radius).toBeDefined();
    expect(circle(3).area).toBeDefined();
    expect(circle(3).circumference).toBeDefined();
    // Teste se a função, quando não recebe nenhum parâmetro, retorna undefined.
    expect(circle()).toEqual(undefined);
    // Teste se dentro do objeto retornado, a função retorna uma `key` com `value` igual à circunferência correta para um círculo de raio 2 (12.56).
